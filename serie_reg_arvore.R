...
prev <- prev_temp_tree(2001)

b <- c()
for(i in 1:length(prev)){
  wr <- (prev[1:i]>0) == (teste19$result[1:i] > 0)
  b[i] <- mean(wr)
}
...
text(600,.95,"Reg em Arvore",cex=1.5)

####################

prev <- prev_temp_tree(2002)
