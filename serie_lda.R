...
prev <- prev_temp_lda(2001)

b <- c()
for(i in 1:length(prev)){
  wr <- prev[1:i] == teste19$Win[1:i]
  b[i] <- mean(wr)
}
...
text(600,.95,"LDA",cex=1.5)

####################

prev <- prev_temp_lda(2002)
